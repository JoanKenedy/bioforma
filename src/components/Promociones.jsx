...
import promocion3 from "../assets/promo-3.jpg";
...
const Promociones = () => {
  ...
  const handleNavigation = useCallback(
    (e) => {
      //te regresa la llamada

      if (y > window.scrollY) {
        //verifica la altura del documento para definir si sube o baja
        setScrollDirection("Scrolling Up");
        console.log("scrolling up");
        if (y < 100) {
          //Detectamos cuando estamos más arriba de 100px del top de la pantalla
        ...
        //detecta cuando bajamos el scroll
  ...
  useEffect(() => {
    //Necesario para utilizar el window add event
    ...
    <div>
      ...
      <div className="container-fixed animado" id="animado">
        <div className="tel-fixed">
          <a href="tel:5575015328" target="_blank" rel="noopener noreferrer">
            <img src={tel} alt="" />
          </a>
        </div>
